...
// ボディの重さを大幅増量（基準130g）した際、パワーはそれほど比例して
// 増やしていないため平均的なパワー/重さ比が下がった。以前と同じ体感の
// 加速になるよう、この比の低下分（約2倍）を打ち消す値に調整してある。
const ACCEL_SCALE = 0.004;
...
// ボディの重量増（基準130g）でパワー/重さ比の相場が下がったため、平均的な
// 構成が以前と同じ立ち位置になるようベースラインもあわせて引き下げてある。
const CLIMB_RATIO_BASELINE = 1.2;
