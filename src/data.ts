...
export const PARTS: Part[] = [
  ...
  // Motor
  { id: 'm_lightdash', name: 'ライトダッシュモーター', type: 'motor', stats: { speed: 120, power: 70, cornering: 0, stamina: -30, weight: 14 }, image: motorLightdash },
  ...
  { id: 'm_powerdash', name: 'パワーダッシュモーター', type: 'motor', stats: { speed: 100, power: 120, cornering: 0, stamina: -30, weight: 17 }, image: motorPowerdash },
